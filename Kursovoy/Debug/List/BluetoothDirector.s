...
//    Command line =
//        -f C:\Users\User\AppData\Local\Temp\EWA1C6.tmp
//        (D:\kraizette\STD\VII-VIII\POIP\KURS\KURS\Kursovoy\Applications\Output\BlueTooth\BluetoothDirector.cpp
...
///////////////////////////////////////////////////////////////////////////////
        ...
        PUBLIC _ZN17BluetoothDirectorC1ER9BluetoothR14SensorDirector
        PUBLIC _ZN17BluetoothDirectorC2ER9BluetoothR14SensorDirector
...
//    2 
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI Function _ZN17BluetoothDirectorC2ER9BluetoothR14SensorDirector
        THUMB
// __code __interwork __vfp BluetoothDirector::subobject BluetoothDirector(Bluetooth &, SensorDirector &)
_ZN17BluetoothDirectorC2ER9BluetoothR14SensorDirector:
        PUSH     {R7,LR}
          CFI R14 Frame(CFA, -4)
          CFI CFA R13+8
          CFI FunCall _ZN17BluetoothDirectorC1ER9BluetoothR14SensorDirector
        BL       _ZN17BluetoothDirectorC1ER9BluetoothR14SensorDirector
        POP      {R1,PC}          ;; return
...
_ZN43_INTERNAL_21_BluetoothDirector_cpp_4c75cda3Ut2_C1Ev:
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI Function _ZN17BluetoothDirectorC1ER9BluetoothR14SensorDirector
        THUMB
//    3 BluetoothDirector::BluetoothDirector(Bluetooth& mybluetooth, SensorDirector& mysensordirector): bluetooth(mybluetooth), sensordirector(mysensordirector) {}; 
_ZN17BluetoothDirectorC1ER9BluetoothR14SensorDirector:
        PUSH     {R4-R6,LR}
          CFI R14 Frame(CFA, -4)
          CFI R6 Frame(CFA, -8)
          CFI R5 Frame(CFA, -12)
...
//    8     tFormatData x = sensordirector.GetData();
        LDR      R1,[R4, #+2148]
        ADD      R0,SP,#+352
          CFI FunCall _ZN14SensorDirector7GetDataEv
        BL       _ZN14SensorDirector7GetDataEv
//    9     auto f = Format::GetBlueToothFormat(x);
        ADD      R1,SP,#+352
        ADD      R0,SP,#+176
...
//   12     auto hum = std::get<1>(f) ;
        ...
        MOVS     R2,#+44
          CFI FunCall __aeabi_memcpy4
        BL       __aeabi_memcpy4
//   13     bluetooth.Send(hum) ;
        ADD      R1,SP,#+88
        LDR      R0,[R4, #+2140]
          CFI FunCall _ZN9Bluetooth4SendER10SusuStringILj40EE
        BL       _ZN9Bluetooth4SendER10SusuStringILj40EE
//   14     auto temp = std::get<2>(f) ; 
        ADD      R0,SP,#+176
        ...
        MOVS     R2,#+44
          CFI FunCall __aeabi_memcpy4
        BL       __aeabi_memcpy4
//   15     bluetooth.Send(temp) ;
        ADD      R1,SP,#+44
        LDR      R0,[R4, #+2140]
          CFI FunCall _ZN9Bluetooth4SendER10SusuStringILj40EE
        BL       _ZN9Bluetooth4SendER10SusuStringILj40EE
//   16     auto dewp = std::get<3>(f) ; 
        ADD      R0,SP,#+176
